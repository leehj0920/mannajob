          ...
          <div class="span8">
            <article>
                ...
                <div class="row">
                  ...
                  <div class="span10">                   
                     <form method="post" name="passwordRe" action="/resetok" onsubmit="return pwValidate();">
                     <input type="hidden" name="m_id" value="${m_id}">
                     <div>
                     <label>비밀번호</label><input type="password" name="m_passwd" value="" placeholder="영어 +숫자 8자 이상 ">
                     </div>
                     <div>
                     <label>비밀번호 확인</label><input type="password" name="m_passwd2" value="" placeholder="한 번 더 입력해주세요">
